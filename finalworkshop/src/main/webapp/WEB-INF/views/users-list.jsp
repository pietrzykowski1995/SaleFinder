...
<div class="unit-5 overlay" style="background-image: url('images/hero_1.jpg');">
    <div class="container text-center">
        <h2 class="mb-0">Promocje dla produktu: ${product.name}</h2>
        <%--        <p class="mb-0 unit-6"><a href="index.html">Home</a> <span class="sep">></span> <span>Dodaj promocje</span></p>--%>
    </div>
</div>
<br/>

<div class="col-xl-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
...
<%--                        <span class="text-info p-2 rounded border border-info">${product.price} zł</span>--%>
        ...
        <%--<a href="../../../../../Downloads/jobfinder/job-single.html"
           class="job-item d-block d-md-flex align-items-center freelance">
            <div class="company-logo blank-logo text-center text-md-left pl-3">
                <img src="../../resources/images/logo_1.png" alt="Image" class="img-fluid mx-auto">
            </div>
            <div class="job-details h-100">
                <div class="p-3 align-self-center">
        ...
        <a href="../../../../../Downloads/jobfinder/job-single.html"
           class="job-item d-block d-md-flex align-items-center fulltime">
            <div class="company-logo blank-logo text-center text-md-left pl-3">
                <img src="../../resources/images/company_logo_blank.png" alt="Image" class="img-fluid mx-auto">
            </div>
            <div class="job-details h-100">
        ...
        <a href="../../../../../Downloads/jobfinder/job-single.html"
           class="job-item d-block d-md-flex align-items-center partime">
            <div class="company-logo blank-logo text-center text-md-left pl-3">
                <img src="../../resources/images/logo_2.png" alt="Image" class="img-fluid mx-auto">
            </div>
            <div class="job-details h-100">
                <div class="p-3 align-self-center">
